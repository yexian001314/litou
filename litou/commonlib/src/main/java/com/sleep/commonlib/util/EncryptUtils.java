...
import static com.sleep.commonlib.util.ConvertUtils.bytes2HexString;
import static com.sleep.commonlib.util.ConvertUtils.hexString2Bytes;
...
public class EncryptUtils {
    ...
    /**
     * AES加密后转为Base64编码     euNirWrWgUnbTR/t2ITQ6OZSTejAKDT2
     *                              IV:viAeTPfv0smQjeY2xiiW0g==
     *
     * @param data 明文
...
//            SecureRandom random = new SecureRandom();
            IvParameterSpec ivParameterSpec = new IvParameterSpec(EncodeUtils.base64Decode("viAeTPfv0smQjeY2xiiW0g=="));
