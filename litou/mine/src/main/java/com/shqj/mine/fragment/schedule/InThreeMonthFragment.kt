...
import kotlinx.android.synthetic.main.mine_fragment_in_three_month.*


/**
 * 回款计划 -> 三月内回款
 */
class InThreeMonthFragment : UUBaseListFragment<PaymentScheduleBean.ReturnFundVOSBean, PaymentScheduleBean>() {
    ...
    override fun getLayoutResourse(): Int {
        return R.layout.mine_fragment_in_three_month
    }

    override fun initItemLayout() {
        super.mRecyclerView = in_three_recycler
        super.mSmartLayout = in_three_refresh
    ...
    private fun getData(){
        mPresenter.getPaymentSchedule(REQUEST_PAGE,2)
    }
}
