...
import kotlinx.android.synthetic.main.mine_fragment_after_three_month.*


/**
 * 回款计划 -> 三月后回款
 */
class AfterThreeMonthFragment : UUBaseListFragment<PaymentScheduleBean.ReturnFundVOSBean, PaymentScheduleBean>() {
    ...
    override fun getLayoutResourse(): Int {
        return R.layout.mine_fragment_after_three_month
    }

    override fun initItemLayout() {
        super.mRecyclerView = after_three_recycler
        super.mSmartLayout = after_three_refresh
    ...
    private fun getData(){
        mPresenter.getPaymentSchedule(REQUEST_PAGE,3)
    }
}
