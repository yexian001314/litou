 ...
 */
class MyInvestIndicatorAdapter(private val mTitleDataList: List<String>?,
                               private val mViewPager: ViewPager) : CommonNavigatorAdapter() {
    ...
    override fun getTitleView(context: Context, index: Int): IPagerTitleView {
        ...
        colorTransitionPagerTitleView.selectedColor = context.resources.getColor(R.color.colorAccent)
