 ...
 */
class TicketPresenter(private val view: LoadListDataView<TicketBean>, private val statesLayoutManager: StatesLayoutManager) {
    fun getTicketData(requestPage: Int) {
        ...
        AppRequest.INSTANCE.getTicketData(treeMap, BaseObserver(object : OnLoadDataListener<TicketBean> {
            ...
            override fun onSuccess(data: TicketBean) {
